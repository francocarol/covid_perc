...
if(!exists("run_covid19", mode="function")) source("model1_Brazilian_Model_v2b.R")
...
solver_wrapper_fitval <- function(flag_ = "covid", diff=0, use=c('C', 'M'),
  ...
  params <- c(p = 0.015,perc_threshold = 0.5, home_steep = 5)
  lower <- c(p = 0, perc_threshold = 0.1, home_steep = 0)
  upper <- c(p = 0.2, perc_threshold = 0.9, home_steep = 15)
  data_start <- as.Date("2020-01-20")
  guesses <- list(
c(p=0.025, perc_threshold=0.5, home_steep = 9),
                  c(p=0.02, perc_threshold=0.5, home_steep = 9),
                 c(p=0.025, perc_threshold=0.4, home_steep = 8),
                  c(p=0.02, perc_threshold=0.4, home_steep = 8),
                 c(p=0.015, perc_threshold=0.4, home_steep = 7),
                  c(p=0.03, perc_threshold=0.3, home_steep = 9),
                  c(p=0.02, perc_threshold=0.3, home_steep = 8),
                  c(p=0.025, perc_threshold=0.2, home_steep = 7),
                  c(p=0.02, perc_threshold=0.2, home_steep = 9),
                  c(p=0.015, perc_threshold=0.2, home_steep = 8),
                  c(p=0.015, perc_threshold=0.2, home_steep = 7),
                  
                  c(p=0.025, perc_threshold=0.5, home_steep = 6),
                  c(p=0.02, perc_threshold=0.5, home_steep = 6),
                  c(p=0.025, perc_threshold=0.4, home_steep = 5),
                  c(p=0.02, perc_threshold=0.4, home_steep = 5),
                  c(p=0.015, perc_threshold=0.4, home_steep = 4),
                  c(p=0.03, perc_threshold=0.3, home_steep = 6),
                  c(p=0.02, perc_threshold=0.3, home_steep = 5),
                  c(p=0.025, perc_threshold=0.2, home_steep = 4),
                  c(p=0.02, perc_threshold=0.2, home_steep = 6),
                  c(p=0.015, perc_threshold=0.2, home_steep = 5),
                  c(p=0.015, perc_threshold=0.2, home_steep = 4) ,
                    
                    c(p=0.045, perc_threshold=0.6, home_steep = 6),
                    c(p=0.04, perc_threshold=0.6, home_steep = 6),
                    c(p=0.045, perc_threshold=0.5, home_steep = 5),
                    c(p=0.04, perc_threshold=0.5, home_steep = 5),
                    c(p=0.05, perc_threshold=0.4, home_steep = 6),
                    c(p=0.04, perc_threshold=0.4, home_steep = 5),
                    c(p=0.04, perc_threshold=0.3, home_steep = 6),
                    c(p=0.035, perc_threshold=0.3, home_steep = 5),
                    c(p=0.0415, perc_threshold=0.55, home_steep = 4.6),
                    c(p=0.0415, perc_threshold=0.55, home_steep = 4.5),
                    c(p=0.041, perc_threshold=0.55, home_steep = 4.7)
...
run_the_fitting <- function(flag='srag', diff=1, logscale=FALSE,  use_to_fit = c('C', 'M'), filename, max.date = NA){
print(paste("MAXDATE",max.date))
  ## fitting
  print("Running!")
  s <- solver_wrapper_fitval(flag, diff=diff, use = use_to_fit, logscale=logscale, rollwindow = 1, max.date = max.date)
  print("s solved")
...
solver_wrapper <- function(flag_ = "covid", diff=0, use=c('C', 'M'),
  ...
  params <- c(p = 0.015,perc_threshold = 0.5)
  lower <- c(p = 0, perc_threshold = 0.1)
  upper <- c(p = 0.2, perc_threshold = 0.9)
